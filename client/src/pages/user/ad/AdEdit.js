...
const hasValidGoogleKey = GOOGLE_PLACES_KEY && GOOGLE_PLACES_KEY !== "your-google-places-api-key";
          ...
          {loaded ? (
            hasValidGoogleKey ? (
              ...
              <input
                ...
                placeholder="Enter address manually (Google Places API key not configured)"
                value={ad?.address || ""}
